        ...
        .then(data => {
            ...
            if ('error' in data.response) {
                ...
                for (const location of data.response.location) {
                    tableBody = tableBody + '<tr><td>' + location.prefecture + '</td><td>' + location.city + '</td><td>' + location.town + '</td></tr>'
                }
                resultHtml.innerHTML = '<table border="1"><th>県</th><th>市</th><th>町</th>' + tableBody + '</table>'
            }
        });
}
